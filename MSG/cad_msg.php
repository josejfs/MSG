...
/** @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@**/
	if ($tipo == "CONTATOS") {
		...
		$sql = "INSERT INTO $tipo (cliente, telefone, limite, mensagem) VALUES ('{$cliente}', '{$telefone}', '{$limite}', '{$mensagem}')";
	...
	elseif ($tipo == "CARTÃODECREDITO") {
		...
		echo "<script>alert('ALGO DEU ERRADO, VERIFIQUE SE VOCÊ SELECIONOU O TIPO DA OPERAÇÃO.');window.location.href = 'index.php';</script>";
	}
/** @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ **/
